                ...
                {/* <div className='grid-container-about'> */}
                    <section className='sectionabouteffect' ref={ref} style={{margin:'0'}}>
                         <div className='fade-about-info-items'>
                            {/* <p>Hi! I'm Nicole.</p> */}
                            {/* <br></br> */}
                           <p> With a passion for tech, self-development and the creative arts. I strive to be a part of something that will help me further myself and my skills as well as also having a meaningful impact on the world around. I'm all about continuous improvement! One thing I love to do when I code is trying out random ideas and experimenting with them to see how I can make it come to life!  </p>
                           <br></br>
                           <p>Since graduating, with my MEng in Electronic Engineering, I have rcompleted a 12 week intensive training course with La Fosse Academy expanding my technical knowledge and further improving my skill sets when it comes to software development!</p>
                            <br></br>
